...
3930 M=M-10*RND(-1)-5
3940 GOTO 4710
3950 PRINT "BANDITS ATTACK"
3960 GOSUB 6140
3970 B=B-20*B1
3980 IF B >= 0 THEN 4030
3990 PRINT "YOU RAN OUT OF BULLETS---THEY GET LOTS OF CASH"
4000 T=T/3
4010 GOTO 4040
4020 IF B1 <= 1 THEN 4100
4030 PRINT "YOU GOT SHOT IN THE LEG AND THEY TOOK ONE OF YOUR OXEN"
4040 K8=1
4050 PRINT "BETTER HAVE A DOC LOOK AT YOUR WOUND"
4060 M1=M1-5
4070 A=A-20
4080 GOTO 4710
4090 PRINT "QUICKEST DRAW OUTSIDE OF DODGE CITY!!!"
4100 PRINT "YOU GOT 'EM!"
4110 GOTO 4710
4120 PRINT "THERE WAS A FIRE IN YOUR WAGON--FOOD AND SUPPLIES DAMAGE"
4130 F=F-40
4140 B=B-400
4150 LET M1=M1-RND(-1)*8-3
4160 M=M-15
4170 GOTO 4710
4180 PRINT "LOSE YOUR WAY IN HEAVY FOG---TIME IS LOST"
4190 M=M-10-5*RND(-1)
4200 GOTO 4710
4210 PRINT "YOU KILLED A POISONOUS SNAKE AFTER IT BIT YOU"
4220 B=B-10
4230 M1=M1-5
4240 IF M1 >= 0 THEN 4280
4250 PRINT "YOU DIE OF SNAKEBITE SINCE YOU HAVE NO MEDICINE"
4260 GOTO 5170
4270 GOTO 4710
4280 PRINT "WAGON GETS SWAMPED FORDING RIVER--LOSE FOOD AND CLOTHES"
4290 F=F-30
4300 C=C-20
4310 M=M-20-20*RND(-1)
4320 GOTO 4710
4330 PRINT "WILD ANIMALS ATTACK!"
4340 GOSUB 6140
4350 IF B>39 THEN 4410
4360 PRINT "YOU WERE TOO LOW ON BULLETS--"
4370 PRINT "THE WOLVES OVERPOWERED YOU"
4380 K8=1
4390 GOTO 5120
4400 IF B1>2 THEN 4440
4410 PRINT "NICE SHOOTIN' PARTNER---THEY DIDN'T GET MUCH"
4420 GOTO 4450
4430 PRINT "SLOW ON THE DRAW---THEY GOT AT YOUR FOOD AND CLOTHES"
4440 LET B=B-20*B1
4450 C=C-B1*4
4460 F=F-B1*8
4470 GOTO 4710
4480 PRINT "COLD WEATHER---BRRRRRRR!---YOU ";
4490 IF C>22+4*RND(-1) THEN 4530
4500 PRINT "DON'T ";
4520 C1=1
